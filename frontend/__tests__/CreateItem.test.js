...
const dogImage = 'https://dog.com/dogs/dog.jpg';
...
describe('CreateItem component', () => {
  ...
  it('creates an item when the form is submitted', async () =>{
    ...
    wrapper.find('#price').simulate('change', {target: {value: item.price, name: 'price'}});
    ...
    expect(Router.router.push).toHaveBeenCalledWith({"pathname": "/item", "query": {"id": "364w54v678ot"}});
  });
});
